        ...
        <div class="row">
            ...
            <ul class="grid cs-style-4">
                <li class="col-md-6 col-sm-6">
                    <figure>
                        <div><img src="{{ URL::asset('images/gallery-img1.jpg') }}" alt="image 1"></div>
                        <figcaption>
                            <h1>Sapien arcu</h1>
                ...
                <li class="col-md-6 col-sm-6">
                    <figure>
                        <div><img src="{{ URL::asset('images/gallery-img2.jpg') }}" alt="image 2"></div>
                        <figcaption>
                            <h1>Aliquam erat</h1>
                ...
                <li class="col-md-6 col-sm-6">
                    <figure>
                        <div><img src="{{ URL::asset('images/gallery-img3.jpg') }}" alt="image 3"></div>
                        <figcaption>
                            <h1>Cras ante sem</h1>
                ...
                <li class="col-md-6 col-sm-6">
                    <figure>
                        <div><img src="{{ URL::asset('images/gallery-img4.jpg') }}" alt="image 4"></div>
                        <figcaption>
                            <h1>Sed ornare</h1>
